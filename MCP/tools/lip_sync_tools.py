...
class LipSyncInput(BaseModel):
    ...
    face_image: str | None = Field(default=None, description="Path to face image (for Wav2Lip/SadTalker)")
    face_video: str | None = Field(default=None, description="Path to existing video (for re-sync)")
