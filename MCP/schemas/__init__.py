...
class SearchProductInput(BaseModel):
    ...
    platform: str | None = Field(None, description="Platform filter: shopee, tokopedia")
...
class GenerateOfferInput(BaseModel):
    ...
    review_analysis: AnalyzeReviewsOutput | None = None
    competitor_analysis: AnalyzeCompetitorsOutput | None = None
...
class AffiliatePackageOutput(BaseModel):
    ...
    review_summary: AnalyzeReviewsOutput | None = None
    competitor_analysis: AnalyzeCompetitorsOutput | None = None
    offer_strategy: GenerateOfferOutput | None = None
    hooks: GenerateHooksOutput | None = None
    scripts: GenerateScriptOutput | None = None
    thumbnail: GenerateThumbnailOutput | None = None
    image: GenerateImageOutput | None = None
    video: GenerateVideoOutput | None = None
    avatar: GenerateAvatarOutput | None = None
