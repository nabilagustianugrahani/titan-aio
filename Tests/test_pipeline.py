...
class TestMessageBus:
    ...
    def test_subscribe_multiple_handlers(self):
        results_a, results_b = [], []
        self.bus.subscribe("test.event", lambda e: results_a.append(e))
        self.bus.subscribe("test.event", lambda e: results_b.append(e))
        self.bus.publish("test.event", {"x": 1})
...
class TestPipeline:
    async def test_basic_pipeline(self):
        ...
        events = []
        bus.subscribe("product.analyzed", lambda e: events.append(e))
