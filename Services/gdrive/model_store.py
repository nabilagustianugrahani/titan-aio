...
class GDriveModelStore:
    ...
    def get_cached_path(self, model_key: str) -> Path | None:
    ...
    def download_from_gdrive(self, model_key: str) -> Path | None:
    ...
    def ensure_model(self, model_key: str, hf_download_fn=None) -> Path | None:
    ...
    def _find_folder_id(self, path: str, create: bool = False) -> str | None:
    ...
    def _ensure_folder_path(self, path: str) -> str | None:
