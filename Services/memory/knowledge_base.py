...
class KnowledgeBase:
    ...
    def store_winning_hook(self, hook_text: str, metadata: Optional[dict] = None) -> str:
    ...
    def store_product_knowledge(self, product_id: str, knowledge: str, metadata: Optional[dict] = None) -> str:
