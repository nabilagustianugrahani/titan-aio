...
class SharedState(BaseModel):
    ...
    product: dict | None = None      # AnalyzeProductOutput
    reviews: dict | None = None      # AnalyzeReviewsOutput
    competitors: dict | None = None  # AnalyzeCompetitorsOutput

    # ── Phase 2: Strategy ──────────────────────────────────────────
    offer: dict | None = None        # GenerateOfferOutput
