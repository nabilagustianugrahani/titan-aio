...
from Services.agents.competitor_spy import CompetitorInput, spy_competitor
...
from Services.analytics.ab_stats import ABTestCreate, create_test
...
class CEOAgent:
    ...
    async def generate_thumbnails(self, product_name: str, niche: str = "general", num_variants: int = 3) -> dict:
        ...
        from Services.thumbnail.auto_generator import ThumbnailInput
        from Services.thumbnail.auto_generator import generate_thumbnails as _gen
    ...
    async def send_telegram_alert(self, title: str, message: str, severity: str = "info") -> dict:
        """Send notification (placeholder — Telegram removed)."""
        return {"status": "disabled", "reason": "telegram removed"}
    ...
    async def run_full_pipeline(self, url: str, platforms: list[str] | None = None, niche: str = "general") -> dict:
        ...
        report_data["features_used"].extend(["revenue_forecast", "budget", "reports", "alerts"])
