...
class AutonomousLoop:
    ...
    async def run_once(self, keyword: str = "", category: str = "umum") -> dict:
        ...
        scraper = ScrapeAgent(use_scrapling=True, use_reach=False)
        ...
        try:
            ...
            print(f"   ✅ Synced to Notion Knowledge Base")
        except Exception as e:
    ...
    async def run_continuous(self, interval_minutes: int = 60, max_cycles: int = 10):
        ...
        print(f"\n{'═' * 60}")
        print(f"🤖 TITAN AIO — AUTONOMOUS MODE ACTIVE")
